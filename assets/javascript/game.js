...
//updateLetters will take an input keystroke and set it to the letter parameter. It will then see if that input keystroke matches index in the answerWord. if that is true then it will set the answerWord index value to answerWordLetter. at that point the answerWordLetter will be set to proper hangmanWord index number and then the hangmanWord index will be equal to answerWord index. 
